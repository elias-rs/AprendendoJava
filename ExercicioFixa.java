...
public class ExercicioFixa {
    public static void main(String[] args) {
        ...
        System.out.printf("%nMeasure with eight decimal places: %f%nRounded (three decimal places): %.3f", measure, measure);
